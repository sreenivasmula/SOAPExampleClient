...
<jsp:useBean id="samplePersonServiceImplProxyid" scope="session" class="com.sreeni.jaxws.service.PersonServiceImplProxy" />
<%
...
case 10:
        gotMethod = true;
        com.sreeni.jaxws.service.PersonServiceImpl getPersonServiceImpl10mtemp = samplePersonServiceImplProxyid.getPersonServiceImpl();
...
case 15:
        ...
        com.sreeni.jaxws.beans.Person getPerson15mtemp = samplePersonServiceImplProxyid.getPerson(id_1idTemp);
...
case 26:
        gotMethod = true;
        com.sreeni.jaxws.beans.Person[] getAllPersons26mtemp = samplePersonServiceImplProxyid.getAllPersons();
...
case 29:
        ...
        boolean deletePerson29mtemp = samplePersonServiceImplProxyid.deletePerson(id_2idTemp);
...
case 34:
        ...
        %>
        <jsp:useBean id="com1sreeni1jaxws1beans1Person_3id" scope="session" class="com.sreeni.jaxws.beans.Person" />
        <%
        com1sreeni1jaxws1beans1Person_3id.setAge(age_4idTemp);
        com1sreeni1jaxws1beans1Person_3id.setName(name_5idTemp);
        com1sreeni1jaxws1beans1Person_3id.setId(id_6idTemp);
        boolean addPerson34mtemp = samplePersonServiceImplProxyid.addPerson(com1sreeni1jaxws1beans1Person_3id);
